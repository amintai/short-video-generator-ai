            ...
            <div className="order-2 lg:order-1 space-y-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  Continue creating amazing short videos with AI. Access your projects and start generating content in seconds.
                </p>
              </div>
              ...
              <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-gray-100 shadow-sm">
                ...
                <Link href="/sign-up">
                  <Button className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-medium px-6 py-2 rounded-full transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl">
                    Create Account
                  </Button>
                </Link>
              </div>
