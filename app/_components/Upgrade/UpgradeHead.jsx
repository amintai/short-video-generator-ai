...
const UpgradeHead = ({isYearly, handleSetYearlyPlan}) => {
    return (
        <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <div className="flex items-center justify-center gap-4 mt-8">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                    <input onChange={() => handleSetYearlyPlan(isYearly)} type="checkbox" id="toggleSwitch" className="sr-only peer" defaultChecked={isYearly} />
                    <div className="w-12 h-6 bg-gray-300 peer-checked:bg-[#8338ec] rounded-full peer transition-all duration-300"></div>
                    <div className=" absolute w-5 h-5 bg-white rounded-full left-1  peer-checked:translate-x-6 transition-all duration-300"></div>
                </label>
